...
[功能](#-功能) · [它如何保护你的账号](#%EF%B8%8F-它如何保护你的账号) · [安装](#-安装) · [对比 qmq](#-诚实对比) · [免责声明](#%EF%B8%8F-免责声明)
...
> 为什么这样设计？见 [它如何保护你的账号](#%EF%B8%8F-它如何保护你的账号)。完整威胁模型在 [DESIGN.md](./DESIGN.md)。
...
apps/control-plane           # Fastify + better-sqlite3 控制面板（零凭证，22 tests）
