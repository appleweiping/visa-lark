...
export { UsVisaInfoAdapter } from "./adapter.js";
 ...
 * This is a starter set covering the consulates qmq targets (Asia/Pacific).
 * Users can add their own in the UI. Not exhaustive — verify against your account.
 */
